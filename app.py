...
.sys-brand{display:flex;align-items:center;gap:10px;position:relative;z-index:1}.sys-logo{width:39px;height:39px;border-radius:11px;background:linear-gradient(145deg,#fff,#EAF1FF);display:grid;place-items:center;color:#2758BF;font-size:.72rem;font-weight:950;box-shadow:0 6px 13px rgba(10,31,80,.24),inset 0 1px 0 #fff}
...
def hero(n: int) -> None:
    st.markdown(
        f'''<div class="sys-topbar">
          <div class="sys-brand"><div class="sys-logo">UNT</div><div><div class="sys-brand-title">Tablero Ejecutivo PEI</div><div class="sys-brand-sub">Universidad Nacional de Trujillo</div></div></div>
